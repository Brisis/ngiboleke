...
@section('content')
    ...
    <div class="page-content-wrapper">
      <div class="blog-details-post-thumbnail" style="background-image: url('{{ asset('static/img/bg-img/11.jpg') }}')">
        <div class="container">
      ...
      <div class="product-description pb-3">
        ...
        <div class="product-title-meta-data bg-white mb-3 py-3">
          <div class="container">
            ...
            <div class="post-meta-data d-flex align-items-center justify-content-between"><a class="d-flex align-items-center" href="#"><img src="{{ asset('static/img/bg-img/9.jpg') }}" alt="">Sarah<span>Follow</span></a><span class="d-flex align-items-center">
            ...
            <div class="rating-review-content">
              <ul class="ps-0">
                <li class="single-user-review d-flex">
                  <div class="user-thumbnail mt-0"><img src="{{ asset('static/img/bg-img/7.jpg') }}" alt=""></div>
                  <div class="rating-comment">
                    <p class="comment mb-0">Very good product. It's just amazing!</p><span class="name-date">Designing World 12 Dec 2021</span>
                  </div>
                </li>
                <li class="single-user-review d-flex">
                  <div class="user-thumbnail mt-0"><img src="{{ asset('static/img/bg-img/8.jpg') }}" alt=""></div>
                  <div class="rating-comment">
                    <p class="comment mb-0">Very excellent product. Love it.</p><span class="name-date">Designing World 8 Dec 2021</span>
                  </div>
                </li>
                <li class="single-user-review d-flex">
                  <div class="user-thumbnail mt-0"><img src="{{ asset('static/img/bg-img/9.jpg') }}" alt=""></div>
                  <div class="rating-comment">
