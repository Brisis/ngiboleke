...
@section('content')
    ...
    <div class="header-area" id="headerArea">
      <div class="container h-100 d-flex align-items-center justify-content-between">
        <!-- Back Button-->
        <div class="back-button"><a href="{{ route('blogs') }}">
    ...
    <div class="page-content-wrapper">
      <div class="blog-details-post-thumbnail" style="background-image: url('{{ asset('static/img/bg-img/bridal.jpeg') }}')">
        <div class="container">
      ...
      <div class="product-description pb-3">
        ...
        <div class="product-title-meta-data bg-white mb-3 py-3">
          <div class="container">
            ...
            <div class="post-meta-data d-flex align-items-center justify-content-between"><a class="d-flex align-items-center" href="#"><i class="lni lni-user"></i> Ngiboleke<span>Follow</span></a><span class="d-flex align-items-center">
            ...
            <div class="rating-review-content">
              <ul class="ps-0">
                <li class="single-user-review d-flex">
                  <div class="user-thumbnail mt-0"><img src="{{ asset('static/img/user.png') }}" alt=""></div>
                  <div class="rating-comment">
                    <p class="comment mb-0">Very good product. It's just amazing!</p><span class="name-date">CoderIam | 12 Mar 2022</span>
                  </div>
                </li>
                <li class="single-user-review d-flex">
                  <div class="user-thumbnail mt-0"><img src="{{ asset('static/img/user.png') }}" alt=""></div>
                  <div class="rating-comment">
                    <p class="comment mb-0">Very excellent product. Love it.</p><span class="name-date">CoderIam | 8 Feb 2022</span>
                  </div>
                </li>
                <li class="single-user-review d-flex">
                  <div class="user-thumbnail mt-0"><img src="{{ asset('static/img/user.png') }}" alt=""></div>
                  <div class="rating-comment">
                    <p class="comment mb-0">What a nice product it is. I am looking it's.</p><span class="name-date">CoderIam 28 | Jan 2022</span>
                  </div>
                </li>
              </ul>
            </div>
