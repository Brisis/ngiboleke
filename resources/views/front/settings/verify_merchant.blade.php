        ...
        <div class="row justify-content-center">
          <div class="col-12 col-sm-9 col-md-7 col-lg-6 col-xl-5">
            ...
            <div class="text-start px-4">
              <h5 class="mb-1 text-white">Ngiboleke Merchant Verification</h5>
            ...
            <div class="register-form otp-form mt-3 mx-4">
              <form action="{{ route('seller.verify') }}" method="post" enctype="multipart/form-data">
                @csrf
                ...
                <div class="mb-4 form-group text-start">
                  ...
                  <select class="form-select" name="purpose" required>
                    <option value="Merchant Verification" selected>Merchant Verification</option>
                  </select>
                </div>
                <div class="form-group text-start mb-4">
                  <span>Store Identification Document</span>
