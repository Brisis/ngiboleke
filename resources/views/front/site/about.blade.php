          ...
          <div class="card-body">
            <div class="about-content-wrap"><img class="mb-3" src="{{ asset('static/img/bg-img/12.png') }}" alt="">
              ...
              <div class="contact-btn-wrap text-center">
                <p class="mb-2">For more information, submit a request.</p><a class="btn btn-primary w-100" href="{{ route('contact') }}"><i class="lni lni-life-ring me-2"></i>Submit A Query</a>
              </div>
            </div>
          </div>
        </div>
