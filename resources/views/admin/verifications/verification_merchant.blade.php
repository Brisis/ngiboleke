...
@section('content')
    ...
    <main class="main-wrap">
        ...
        <section class="content-main">
            <div class="row">
                <form action="{{ route('admin.verifications.verification_merchant', $verification->id) }}" method="post">
                  @csrf
                  <div class="col-9">
                      <div class="content-header">
                          <h2 class="content-title">Purpose: {{ $verification->purpose }}</h2>
                          @if(!$verification->user->merchant->verified)
                          <div>
                ...
                <div class="col-9">
                  <div class="card mb-4">
                    <div class="card-header">
                        <h4>Verify: {{ $verification->user->merchant->name }} @if($verification->user->merchant->verified) <i class="icon material-icons md-verified"></i> @endif</h4>
                    </div>
                  </div>
                </div>
