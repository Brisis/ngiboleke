            ...
            <ul class="menu-aside">
                ...
                <li class="menu-item has-submenu active">
                    ...
                    <div class="submenu">
                        ...
                        <a href="page-transactions-2.html" class="active">Transaction 2</a>
                    </div>
                </li>
                <li class="menu-item has-submenu">
                    ...
                    <div class="row">
                        ...
                        <aside class="col-lg-3">
                            <div class="box bg-light" style="min-height:80%">
                                ...
                                <p><template class="__cf_email__" data-cfemail="6a191f1a1a05181e2a0f120b071a060f44090507">[email&#160;protected]</template></p><br>
