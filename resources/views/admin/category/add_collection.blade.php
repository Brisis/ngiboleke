...
@section('content')
    ...
    <main class="main-wrap">
        ...
        <section class="content-main">
          <form action="{{ route('admin.categories.add_collection', $category->id) }}" method="post" enctype="multipart/form-data">
            @csrf
            <div class="row">
                <div class="col-10">
                    <div class="content-header">
                        <h2 class="content-title">Add Collection to {{ $category->name }}</h2>
                        <div>
