  ...
  @section('content')
      ...
      <main class="main-wrap">
          ...
          <section class="content-main">
            <form action="{{ route('seller.edit_picture')}}" method="post" enctype="multipart/form-data">
              @csrf
              <div class="row">
                  ...
                  <div class="col-lg-9">
                      <div class="card mb-4">
                          <div class="card-header">
                            <h5 class="card-title">Merchant Profile Image</h5>
                          </div>
                          <div class="card-body">
                              <div class="mb-4">
                              ...
                              <div class="mb-4">
                                  ...
                                  <input id="pictureInput" class="form-control" type="file" accept="image/*" name="merchant_logo">
                              </div>
                          </div>
                      </div> <!-- card end// -->
                  </div>
