...
@section('content')
    ...
    <main class="main-wrap">
        ...
        <section class="content-main">
          ...
          <form action="{{ route('seller.products.add_hirepurchase', $product->id) }}" method="post">
            @csrf
            <div class="row">
                <div class="col-9">
                    <div class="content-header">
                        <h2 class="content-title">Add Hire Purchase</h2>
                        <div>
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    <div class="mb-4">
                                        <label class="form-label">HP Percentage</label>
                                        <input placeholder="%" type="number" min="0" step=".01" class="form-control" name="percentage">
                                    </div>
                                </div>
                            </div>
                            <div class="mb-4">
                                <label class="form-label">HP Policy (optional)</label>
