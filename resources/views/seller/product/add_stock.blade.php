...
@section('content')
    ...
    <main class="main-wrap">
        ...
        <section class="content-main">
          <form action="{{ route('seller.products.add_stock', $product->id) }}" method="post">
            @csrf
            <div class="row">
                <div class="col-9">
                    <div class="content-header">
                        <h2 class="content-title">Add Stock /<span class="badge font-sm"><a href="{{ route('seller.products.edit', $product->id)}}">Back</a></span></h2>
                        <div>
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            <div class="mb-4">
                                ...
                                <input type="number" min="1" step="1" placeholder="Type here" class="form-control" id="stock" name="stock">
                            </div>
                        </div>
                    </div> <!-- card end// -->
                </div>
